...
namespace org.ow2.proactive.scheduler.common.exception
{
	...
	/// </summary>
	public class AccessRightException : SchedulerException
	{
		...
		public AccessRightException(string msg) : base(msg)
		{
		}
		...
		public AccessRightException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public AccessRightException(Exception cause) : base(cause)
		{
		}
