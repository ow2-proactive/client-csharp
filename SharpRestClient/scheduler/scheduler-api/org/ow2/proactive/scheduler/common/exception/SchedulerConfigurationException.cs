...
namespace org.ow2.proactive.scheduler.common.exception
{
	...
	/// </summary>
	public class SchedulerConfigurationException : SchedulerException
	{
		/// <summary>
		/// Create a new instance of SchedulerConfigurationException
		/// </summary>
		/// <param name="msg"> the message to attach. </param>
		public SchedulerConfigurationException(string msg) : base(msg)
		{
		}
		...
		/// 
		/// </summary>
		public SchedulerConfigurationException() : base()
		{
		}
		...
		public SchedulerConfigurationException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public SchedulerConfigurationException(Exception cause) : base(cause)
		{
		}
	}
