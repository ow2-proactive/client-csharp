...
//ORIGINAL LINE: @PublicAPI public class TaskAbortedException extends SchedulerException
	public class TaskAbortedException : SchedulerException
	{
		...
		public TaskAbortedException(string msg) : base(msg)
		{
		}
		...
		public TaskAbortedException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public TaskAbortedException(Exception cause) : base(cause)
		{
		}
