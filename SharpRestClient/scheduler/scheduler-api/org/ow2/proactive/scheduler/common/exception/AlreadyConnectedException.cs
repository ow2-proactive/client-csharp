...
namespace org.ow2.proactive.scheduler.common.exception
{
	...
	/// </summary>
	public class AlreadyConnectedException : SchedulerException
	{
		...
		public AlreadyConnectedException(string msg) : base(msg)
		{
		}
		...
		public AlreadyConnectedException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public AlreadyConnectedException(Exception cause) : base(cause)
		{
		}
	}
