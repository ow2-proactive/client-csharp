...
//ORIGINAL LINE: @PublicAPI public class TaskRestartedException extends SchedulerException
	public class TaskRestartedException : SchedulerException
	{
		...
		public TaskRestartedException(string msg) : base(msg)
		{
		}
		...
		public TaskRestartedException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public TaskRestartedException(Exception cause) : base(cause)
		{
		}
