...
//ORIGINAL LINE: @PublicAPI public class ExecutableCreationException extends SchedulerException
	public class ExecutableCreationException : SchedulerException
	{
		...
		public ExecutableCreationException(string msg) : base(msg)
		{
		}
		...
		/// </summary>
		public ExecutableCreationException() : base()
		{
		}
		...
		public ExecutableCreationException(string msg, Exception cause) : base(msg, cause)
		{
		}
		...
		/// </summary>
		/// <param name="cause"> the cause of the exception. </param>
		public ExecutableCreationException(Exception cause) : base(cause)
		{
		}
	}
