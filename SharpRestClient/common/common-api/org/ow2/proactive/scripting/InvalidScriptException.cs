...
//ORIGINAL LINE: @PublicAPI public class InvalidScriptException extends Exception
	public class InvalidScriptException : Exception
	{
		...
		public InvalidScriptException(string message, Exception cause) : base(message, cause)
		{
		}
		...
		/// <summary>
		/// Constructor </summary>
		/// <param name="cause"> wrapped execption. </param>
		public InvalidScriptException(Exception cause) : base("", cause)
		{
		}
	}
