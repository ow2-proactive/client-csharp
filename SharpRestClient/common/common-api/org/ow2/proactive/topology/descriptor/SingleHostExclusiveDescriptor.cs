...
//ORIGINAL LINE: @PublicAPI public class SingleHostExclusiveDescriptor extends SingleHostDescriptor
	[Serializable]
	public class SingleHostExclusiveDescriptor : SingleHostDescriptor
	{

		/// <summary>
		/// Constructs the new instance of this class.
		/// </summary>
		public SingleHostExclusiveDescriptor() : base()
		{
		}
	}
